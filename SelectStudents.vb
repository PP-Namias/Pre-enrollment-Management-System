...
Public Class SelectStudents
    ...
    Private Sub Select_Student_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub SelectStudents_Load(sender As Object, e As EventArgs) Handles MyBase.Load
